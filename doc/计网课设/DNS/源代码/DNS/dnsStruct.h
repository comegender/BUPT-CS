...
dns_addr set_domain_name(dns_addr buffer, char* name);
...
dns_addr set_answer(struct dns_message* msg, dns_addr buffer, struct ip_list_node** head, int cnt);
